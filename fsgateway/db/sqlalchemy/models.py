...
#    under the License.
"""
SQLAlchemy models for fsgateway data.
"""
...
from fsgateway.db.sqlalchemy import types
from fsgateway.common import timeutils
...
class GWBase(models.SoftDeleteMixin,
    ...
    # TODO(ekudryashova): remove this after both fsgateway and oslo.db
    # will use oslo.utils library
    # NOTE: Both projects(fsgateway and oslo.db) use `timeutils.utcnow`, which
    ...
    def save(self, session=None):
        from fsgateway.db.sqlalchemy import api
