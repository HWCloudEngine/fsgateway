...
import fsgateway.context
from fsgateway.db.sqlalchemy import models
...
def require_context(f):
    ...
    :py:func:`fsgateway.context.authorize_project_context` and
    :py:func:`fsgateway.context.authorize_user_context`.
    ...
    def wrapper(*args, **kwargs):
        fsgateway.context.require_context(args[0])
