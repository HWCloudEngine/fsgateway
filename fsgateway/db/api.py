...
Functions in this module are imported into the fsgateway.db namespace. Call these
functions from fsgateway.db namespace, not the fsgateway.db.api namespace.
...
_BACKEND_MAPPING = {'sqlalchemy': 'fsgateway.db.sqlalchemy.api'}
