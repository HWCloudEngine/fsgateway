...
from fsgateway.utils import get_project_id
from fsgateway.association import project_association as project_mapping
from fsgateway import users
from fsgateway.common import excutils
from keystoneclient.openstack.common.apiclient import exceptions
from fsgateway.repoze_lru import ExpiringLRUCache as expire_lru, LRUCache as lru
        ...
        if not new_token:
            if not user_info:
                ...
                if not cascading_tenant_id or not cascaded_tenant_id:
                    ...
                    return render_response(status=(500, 'fsgateway service error'))
