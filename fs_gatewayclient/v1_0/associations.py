...
from fs_gatewayclient import base
...
class AssociationManager(base.ManagerWithFind):
    ...
    filter_items = ( "h%(name)s", "%(name)s", "region", "userid" )
    ...
    def list(self):
        ...
        return self._list("/%s_association" % self.name, "associations")
    ...
    def get(self, association):
        ...
        """
        return self._get("/%s_association/%s" % (self.name, base.getid(association)), "association")
    ...
    def delete(self, association):
        ...
        :param association: The ID of the :class:`Association` to get.
        """
        self._delete("/%s_association/%s" % (self.name, base.getid(association)))
    ...
    def update(self, id, **info):
        ...
        if not body:
            return
        return self._update("/%s_association/%s" % (self.name, id), body, "association")
    ...
    def create(self, **info):
        ...
        return self._create("/%s_association" % self.name, body, "association")
