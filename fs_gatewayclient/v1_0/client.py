...
from fs_gatewayclient.v1_0 import certs
from fs_gatewayclient.v1_0 import users
from fs_gatewayclient.v1_0 import associations
from fs_gatewayclient.v1_0 import versions
...
class Client(object):
    ...
    keystoneclient.session API::
        ...
        >>> from fs_gatewayclient.client import Client
    ...
    def __init__(self, username=None, api_key=None, project_id=None,
        ...
        # NOTE(cyeoh): In the fs_gatewayclient context (unlike Nova) the
