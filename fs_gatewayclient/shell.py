...
import fs_gatewayclient
import fs_gatewayclient.auth_plugin
...
class SecretsHelper(object):
    ...
    def management_url(self):
        ...
        management_url = None
        try:
            block = keyring.get_password('fs_gatewayclient_auth', self._make_key())
            if block:
...
class OpenStackComputeShell(object):
    ...
    def get_base_parser(self):
        ...
        parser.add_argument('--version',
                            action='version',
                            version=fs_gatewayclient.__version__)
        ...
        fs_gatewayclient.auth_plugin.load_auth_system_opts(parser)
    ...
    def main(self, argv):
        ...
        fs_gatewayclient.auth_plugin.discover_auth_systems()
        ...
        if os_auth_system and os_auth_system != "keystone":
            auth_plugin = fs_gatewayclient.auth_plugin.load_plugin(os_auth_system)
        else:
            auth_plugin = None
    ...
    def do_bash_completion(self, _args):
        ...
        fs_gateway.bash_completion script doesn't have to hard code them.
        """
        commands = set()
        options = set()
...
def main():
    try:
        ...
        print("... terminating fs_gateway client", file=sys.stderr)
        sys.exit(130)
